    ...
    <div className="container-sucursales">
      ...
      <div className="sucursal-info">
        <div className="sucursal-info1">
          <p>
            Conoce las diferentes oficinas de atención al público que ponemos a
            disposición de los usuarios en todo el país.
          </p>
        </div>
        <div className="sucursal-img">
          <img
            src={mapaSucursal}
            className="img-mapa"
            alt="Mapa de sucursales del banco"
          />
        </div>
      ...
      <div className="sucursal-contacto">
        ...
        <p>
          Puedes contactarnos para más información sobre nuestras sucursales.
        </p>
      </div>
    </div>
  );
